  ...
  return (
    <div className="form-group theme-color-picker" style={{ marginBottom: 14 }} ref={wrapRef}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginBottom: hint ? 4 : 8 }}>
        <label style={{ color: '#003366', fontWeight: 700, margin: 0 }}>{label}</label>
        <button
          type="button"
      ...
      {hint && <div style={{ fontSize: 11, color: '#556677', marginBottom: 8, lineHeight: 1.6 }}>{hint}</div>}

      {allowAuto && (
        <label style={{
          display: 'inline-flex', alignItems: 'center', gap: 8, marginBottom: 10, cursor: 'pointer',
          fontSize: 12, fontWeight: 600, color: '#334455',
        }}>
          <input
            type="checkbox"
            checked={isAuto}
        ...
        <>
          <div style={{ display: 'flex', gap: 10, alignItems: 'stretch' }}>
            ...
            <input
              ...
              style={{
                flex: 1, padding: '10px 12px', borderRadius: 8, border: '1px solid #c5d0e0',
                fontSize: 14, fontFamily: 'ui-monospace, monospace', color: '#0a1a2e', background: '#fff',
              }}
            />
            <input
              type="color"
          ...
          {open && (
            <div style={{
              marginTop: 10, padding: 12, borderRadius: 12, border: '1px solid #c5d0e0',
              background: '#fff', boxShadow: '0 8px 28px rgba(0,30,60,0.15)', maxWidth: 240,
            }}>
              <HexColorPicker
                color={displayHex}
              ...
              />
              <div style={{ fontSize: 10, color: '#778899', marginTop: 8, textAlign: 'center' }}>
      ...
      {isAuto && (
        <div style={{
          ...
          background: '#eef4fb', border: '1px dashed #b8c8dc', fontSize: 12, color: '#556677',
        }}>
          <span style={{
